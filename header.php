    ...
    <div class="container">
        <a class="navbar-brand" href="<?php echo esc_url(get_home_url()); ?>">
            ...
            if (get_theme_mod('tk_header_logo')) : ?>
                <div>
                    <img style="max-width: 200px; max-height: 50px;" src="<?php echo esc_url(get_theme_mod('tk_header_logo')); ?>" alt="<?php echo esc_attr(get_bloginfo('name', 'display')); ?>">
                </div>
            <?php
            else : ?>
                Navbar
        ...
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#bs-example-navbar-collapse-1" aria-controls="bs-example-navbar-collapse-1" aria-expanded="false" aria-label="<?php esc_attr_e('Toggle navigation', 'tk-theme'); ?>">
